...
volatile uint8_t  DCF77_errcounter =0; // Anzahl Fehler in Folge
...
#pragma mark Synchronisation
                     ...
                     {
                        //uint8_t newminute=0;
                        uint8_t DCF77_erfolg = UhrAbrufen(); // DCF77-Uhr abrufen
                  ...
                  if (BUS_Status & (1<<TWI_CONTROLBIT)) // uhrstatus & (1<<SYNC_OK);
                  {
